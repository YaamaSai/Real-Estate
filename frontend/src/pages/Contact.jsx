        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-[2.5rem] shadow-xl border border-slate-100 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-sm font-black text-slate-900 leading-tight">{contact?.address || "Bridl360, 303, JNTU Rd, beside Nexus Mall, Kukatpally Housing Board Colony, K P H B Phase 6, Kukatpally, Hyderabad, Telangana 500085"}</p>
            </div>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-10 pt-4">
              ...
              <div className="h-86 rounded-[2.5rem] overflow-hidden border border-slate-100 shadow-md">
                <iframe
